...
if __name__ == '__main__':
    ...
    net.add_conv(patch_size=16, in_depth=num_channels, out_depth=4, activation='relu', pooling=True, name='conv1')
    net.add_conv(patch_size=8, in_depth=4, out_depth=16, activation='relu', pooling=True, name='conv2')
    # net.add_conv(patch_size=4, in_depth=4, out_depth=2, activation='relu', pooling=True, name='conv3')
    # net.add_conv(patch_size=4, in_depth=2, out_depth=1, activation='relu', pooling=True, name='conv4')
    ...
    net.add_fc(in_num_nodes=1024, out_num_nodes=3, activation='relu', name='fc2')

    net.define_model()
    net.run(X_train, y_train, X_test, y_test, train_data_iterator=train_data_iterator,
            iteration_steps=4000, test_data_iterator=test_data_iterator)

    # net.test(X_test, y_test, test_data_iterator)
